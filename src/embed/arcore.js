...
// immediate feedback.
function ARcore(selector, contentInfo) {
    console.log('ARcore constructor');

    var viewEl = document.querySelector(selector);

    var LoadingIndicator = require('./loading-indicator');
    var loadIndicator = new LoadingIndicator(viewEl);
    ...
    var stats = new Stats();
    var scene = SceneInfo.loadFromAPIParams(contentInfo);// SceneInfo.loadFromGetParams();
